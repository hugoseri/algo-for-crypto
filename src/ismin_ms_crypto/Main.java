...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        BigNumber B = new BigNumber(0, prime_number, 7);

        System.out.println("java : " + A.modular_add_java(B, modulo));
        A.modular_add(B, modulo);
        System.out.println("diy : " + A.toBigInteger());

        System.out.println("java : " + A.modular_sub_java(B, modulo));
